...
public class classwork {
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            System.out.println("Left subtree levels: "+bt.getLeftSubtreeLevels()+" Right subtree levels: "+bt.getRightSubtreeLevels());
            if(Math.abs(bt.getLeftSubtreeLevels()-bt.getRightSubtreeLevels()) > 1) {
                System.out.println("Tree is not balanced.");
           
                    System.out.println("Would you like to balance the tree? (y/n)");
                    if(sc.next().equals("y")) {
                        bt.balance();
                        System.out.println("In Order: "+bt.InOrderString());
                        System.out.println("Pre Order: "+bt.toStringPreOrder());
